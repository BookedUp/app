...
public class UpdateAccommodationFragment extends Fragment {
    ...
    private CheckBox freeWiFiCheckBox, nonSmokingCheckBox;
     ...
     * @return A new instance of fragment UpdateAccommodationFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UpdateAccommodationFragment newInstance(String param1, String param2) {
    ...
    private void initView(View view) {
        ...
        freeWiFiCheckBox = view.findViewById(R.id.freeWiFi);
        nonSmokingCheckBox = view.findViewById(R.id.nonSmoking);
    ...
    private void setFixedData() {
        nameEditText.setText("OceanViewEscape");
        overviewEditText.setText("Indulge in panoramic ocean views from this luxurious coastal retreat. The three-bedroom villa features contemporary design, a fully equipped gourmet kitchen, and a private terrace for soaking in the sea breeze. Enjoy access to resort-style amenities, including a beachfront pool and spa. Ideal for a tranquil getaway or entertaining guests.");
        addressStreetEditText.setText("123 Ocean View Street"); // Replace with the actual address
        addressCityEditText.setText("Coastal City"); // Replace with the actual city
        addressPostalCodeEditText.setText("12345"); // Replace with the actual postal code
        addressCountryEditText.setText("Seaside Country"); // Replace with the actual country
        priceEditText.setText("200.0");
        minimumGuestsEditText.setText("2");
        maximumGuestsEditText.setText("4");
        cancellationEditText.setText("7");

        // Set checkboxes
        perNightCheckBox.setChecked(true);
        perGuestCheckBox.setChecked(false);

        // Set accommodation type checkboxes
        hotelCheckBox.setChecked(true); // Assuming it's a hotel
        hostelCheckBox.setChecked(false);
        villaCheckBox.setChecked(false);
        apartmentCheckBox.setChecked(false);
        resortCheckBox.setChecked(false);

        // Additional setup or listeners if needed
        //freeWiFiCheckBox.setChecked(true);
        //nonSmokingCheckBox.setChecked(true);

        Calendar startDate1 = Calendar.getInstance();
        startDate1.set(2023, Calendar.DECEMBER, 1);

        Calendar endDate1 = Calendar.getInstance();
        endDate1.set(2023, Calendar.DECEMBER, 10);

        addedDates.add(new DateRange(startDate1.getTime(), endDate1.getTime()));

        Calendar startDate2 = Calendar.getInstance();
        startDate2.set(2023, Calendar.DECEMBER, 15);

        Calendar endDate2 = Calendar.getInstance();
        endDate2.set(2023, Calendar.DECEMBER, 20);

        addedDates.add(new DateRange(startDate2.getTime(), endDate2.getTime()));
    ...
    private void setupListeners() {
        ...
        addAccommodationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showSuccessPopupBigger("Accommodation successfully updated!");
            }
        });
    }
